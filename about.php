...
<head>
    ...
    <script>
        ...
        function change2() {
            ...
            document.getElementById("h2text").innerText = "Fu-En Huang";
        }
    </script>
</head>
    ...
    <table width="70%" border="1">
        <tr>
            ...
            <td>
                ...
                Tel:
                <a href="tel:04-26328001,18110">
                    04-26328001#18110
                </a>
                <br>

                E-Mail:
                <a href="mailto:a0989100151@gmail.com">
                    a0989100151@gmail.com
                </a>
                <br>
            </td>
